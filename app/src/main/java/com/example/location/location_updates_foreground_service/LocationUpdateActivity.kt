 ...
 */
class LocationUpdateActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
    ...
    private inner class MyReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (location != null) {
                Toast.makeText(
                    this@LocationUpdateActivity, Utils.getLocationText(location),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }
    ...
    companion object {
        private val TAG = LocationUpdateActivity::class.java.simpleName
