package com.example.location.current_location_kotlin
...
import com.example.location.databinding.CurrentLocationActivityBinding
...
class CurrentLocationActivity : AppCompatActivity() {
    private lateinit var binding: CurrentLocationActivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = CurrentLocationActivityBinding.inflate(layoutInflater)
